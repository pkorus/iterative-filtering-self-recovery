function [q_map, dist_L1, dist_L2] = allocate_line_descriptor_bits(bits)
...
%     
    ...
    while allocated < bits
        ...
        for i = 2:1000
            ...
            if (bits - allocated < 0) || q_mapu(i) == 4 || (bits - allocated < 4 && bits - allocated > 2*sum(q_mapu==1) + sum(q_mapu==2))
                continue
            end
